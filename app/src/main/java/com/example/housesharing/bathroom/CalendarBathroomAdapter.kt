...
class CalendarBathroomAdapter(private var list: List<CalendarDateModel>, private val clickListener: OnItemClickListener): RecyclerView.Adapter<CalendarBathroomAdapter.CalendarBathroomViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CalendarBathroomViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val binding = CalendarViewBinding.inflate(layoutInflater, parent, false)
        return CalendarBathroomViewHolder(binding)
    }

    override fun onBindViewHolder(holder: CalendarBathroomViewHolder, @SuppressLint("RecyclerView") position: Int) {
    ...
    class CalendarBathroomViewHolder(val binding: CalendarViewBinding) : RecyclerView.ViewHolder(binding.root) {
